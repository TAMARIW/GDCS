...
extern "C" {
	...
	{
		// TODO: Might be necessary to add spi_num here to distinguish in the case only one DW100 should be enabled
		UWBirq1.interruptEnable(false);
		UWBirq2.interruptEnable(false);
	...
	void decamutexoff(decaIrqStatus_t s)        // put a function here that re-enables the interrupt at the end of the critical section
	{
		...
		UWBirq1.interruptEnable(true);
		UWBirq2.interruptEnable(true);
	}
