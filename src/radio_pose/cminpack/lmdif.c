...
__cminpack_attr__ int __cminpack_func__(lmdif)(__cminpack_decl_fcn_mn__ void *p, int m, int n, real *x, real *fvec, real ftol, real xtol, real gtol, int maxfev, real epsfcn, real *diag, int mode,
                                               real factor, int nprint, int *nfev, real *fjac, int ldfjac, int *ipvt, real *qtf, real *wa1, real *wa2, real *wa3, real *wa4) {
    /* Initialized data */
...
#define p0001 1e-4
    ...
    *nfev = 1;
    ...
    for (;;) {
        ...
        iflag = __cminpack_func__(fdjac2)(__cminpack_param_fcn_mn__ p, m, n, x, fvec, fjac, ldfjac, epsfcn, wa4);
        *nfev += n;
        if (iflag < 0) {
            goto TERMINATE;
        }
        ...
        __cminpack_func__(qrfac)(m, n, fjac, ldfjac, TRUE_, ipvt, n, wa1, wa2, wa3);
        ...
        do {
            ...
            __cminpack_func__(lmpar)(n, fjac, ldfjac, ipvt, diag, qtf, delta, &par, wa1, wa2, wa3, wa4);
